...
home_price = 150000  # Investment cost
...
# YOUR CODE HERE!
present_value = (expected_sale_price)/(1+hurdle_rate/12)
...
if present_value > home_price: 
    print("buy this shizz you dummy")
else: print("bad deal tell them to kick rocks")
